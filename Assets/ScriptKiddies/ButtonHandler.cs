...
public void On_Click_Successful_Login(){
    ...
    public void On_Click_Comp()
    {
        SceneManager.LoadScene("compet");
    }
    public void On_Click_Pers()
    {
        SceneManager.LoadScene("persistance");
    }
    public void On_Click_Problem_Solving()
    {
        SceneManager.LoadScene("ProblemSolving");
    }
}
